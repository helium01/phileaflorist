        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="left-image">
                    <img src="{{asset('assets/front')}}/assets/images/featured.jpg" alt="">
                    <a href="property-details.html"><img src="{{asset('assets/front')}}/assets/images/featured-icon.png"
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                            ...
                            <div class="accordion-body">
                                ...
                                your business. TemplateMo provides you the <a
                                    ...
                                    free CSS templates</a> in the world. Please tell your
            ...
            <div class="col-lg-3">
                <div class="info-table">
                    <ul>
                        <li>
                            <img src="{{asset('assets/front')}}/assets/images/info-icon-01.png" alt=""
                                style="max-width: 52px;">
                            <h4>250 m2<br><span>Total Flat Space</span></h4>
                        </li>
                        <li>
                            <img src="{{asset('assets/front')}}/assets/images/info-icon-02.png" alt=""
                                style="max-width: 52px;">
                            <h4>Contract<br><span>Contract Ready</span></h4>
                        </li>
                        <li>
                            <img src="{{asset('assets/front')}}/assets/images/info-icon-03.png" alt=""
                                style="max-width: 52px;">
                            <h4>Payment<br><span>Payment Process</span></h4>
                        </li>
                        <li>
                            <img src="{{asset('assets/front')}}/assets/images/info-icon-04.png" alt=""
                                style="max-width: 52px;">
        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div class="video-frame">
                    <img src="{{asset('assets/front')}}/assets/images/video-frame.jpg" alt="">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="appartment" role="tabpanel"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <img src="{{asset('assets/front')}}/assets/images/deal-01.jpg" alt="">
                                    </div>
                                    <div class="col-lg-3">
                            ...
                            <div class="tab-pane fade" id="villa" role="tabpanel" aria-labelledby="villa-tab">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <img src="{{asset('assets/front')}}/assets/images/deal-02.jpg" alt="">
                                    </div>
                                    <div class="col-lg-3">
                            ...
                            <div class="tab-pane fade" id="penthouse" role="tabpanel" aria-labelledby="penthouse-tab">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <img src="{{asset('assets/front')}}/assets/images/deal-03.jpg" alt="">
                                    </div>
                                    <div class="col-lg-3">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="item">
                    <a href="property-details.html"><img src="{{asset('assets/front')}}/assets/images/property-01.jpg"
                            alt=""></a>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="item">
                    <a href="property-details.html"><img src="{{asset('assets/front')}}/assets/images/property-02.jpg"
                            alt=""></a>
                    <span class="category">Luxury Villa</span>
                    <h6>$1.180.000</h6>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="item">
                    <a href="property-details.html"><img src="{{asset('assets/front')}}/assets/images/property-03.jpg"
                            alt=""></a>
                    <span class="category">Luxury Villa</span>
                    <h6>$1.460.000</h6>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="item">
                    <a href="property-details.html"><img src="{{asset('assets/front')}}/assets/images/property-04.jpg"
                            alt=""></a>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="item">
                    <a href="property-details.html"><img src="{{asset('assets/front')}}/assets/images/property-05.jpg"
                            alt=""></a>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="item">
                    <a href="property-details.html"><img src="{{asset('assets/front')}}/assets/images/property-06.jpg"
                            alt=""></a>
